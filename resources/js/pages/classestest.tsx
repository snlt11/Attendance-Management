                ...
                <div className="relative bg-gradient-to-br from-blue-50 to-indigo-100 p-6 dark:from-blue-950/50 dark:to-indigo-950/50">
                        ...
                        {auth.user.role === 'teacher' ? (
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="w-44">
                                    <DropdownMenuItem onClick={() => handleViewDetails(classItem)} className="flex items-center gap-2">
                                        <Users className="h-4 w-4" />
                                        <span>Manage Students</span>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem onClick={() => handleEdit(classItem)} className="flex items-center gap-2">
                                        <Edit className="h-4 w-4" />
                                        <span>Edit Class</span>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem onClick={() => handleGenerateQR(classItem)} className="flex items-center gap-2">
                    ...
                    <div className="pr-12">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                            {classItem.description || `${classItem.subject.name} course`}
                        </p>
                    </div>
                </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 text-sm">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-sm font-mono font-bold text-gray-900 dark:text-gray-100">{classItem.registration_code}</div>
                            </div>
                        </div>
                    </div>
