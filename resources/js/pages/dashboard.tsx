    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-8 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-100 p-6 dark:from-gray-900 dark:to-gray-800">
                ...
                <Card className="border-0 bg-gradient-to-br from-white/60 via-blue-50/30 to-indigo-50/40 shadow-xl backdrop-blur-lg">
                    <CardHeader className="border-b border-white/20 bg-gradient-to-r from-transparent via-white/10 to-transparent">
                        <div className="flex items-center justify-between">
                            <div>
                        ...
                        <div className="mt-6 flex flex-col gap-4 sm:flex-row">
                            <div className="relative flex-1">
                                ...
                                <Input
                                    ...
                                    className="rounded-lg border-gray-300 bg-white/80 pl-10 shadow-md backdrop-blur-sm focus:border-indigo-500 focus:ring-indigo-500"
                                />
                            </div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <Button
                                    ...
                                    className={statusFilter === 'ongoing' ? 'bg-green-600 hover:bg-green-700' : ''}
                                >
                                    Ongoing
                                </Button>
                                <Button
                                ...
                                <Button
                                    ...
                                    className={statusFilter === 'completed' ? 'bg-gray-600 hover:bg-gray-700' : ''}
                                >
                                    Completed
                                </Button>
                            </div>
                    ...
                    <CardContent className="bg-transparent p-6">
                        <div className="space-y-4">
                            {paginatedClasses.length === 0 ? (
                                <div className="py-12 text-center">
                                    <div className="mx-auto mb-4 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-indigo-100 to-blue-200 shadow-lg">
                                        <BookOpen className="h-12 w-12 text-indigo-600" />
                                    </div>
                                    <p className="text-lg font-semibold text-gray-700">No classes found matching your criteria</p>
                                ...
                                paginatedClasses.map((classItem: RecentClass) => (
                                    <div
                                        key={classItem.id}
                                        className="group relative flex items-center justify-between rounded-xl border border-white/60 bg-gradient-to-r from-white/90 via-white/85 to-white/80 p-6 backdrop-blur-sm transition-all duration-300 hover:border-indigo-200/80 hover:from-white/95 hover:via-white/90 hover:to-white/85 hover:shadow-lg"
                                    >
                                        <div className="flex-1">
                                            ...
                                            <div className="grid grid-cols-1 gap-4 text-sm text-gray-700 sm:grid-cols-3">
                                                <div className="flex items-center rounded-lg border border-indigo-200/60 bg-gradient-to-r from-indigo-50/90 to-blue-50/90 px-3 py-2 backdrop-blur-sm">
                                                    <Users className="mr-2 h-4 w-4 text-indigo-600" />
                                                    <span className="font-semibold">{classItem.teacher}</span>
                                                </div>
                                                <div className="flex items-center rounded-lg border bg-gradient-to-r px-3 py-2 backdrop-blur-sm">
                                        ...
                                        <div className="ml-6 text-right">
                                            <div className="min-w-[120px] rounded-lg border border-indigo-200/60 bg-gradient-to-br from-indigo-100/85 via-blue-100/85 to-purple-100/85 p-4 shadow-md backdrop-blur-sm">
                                                <div
                                                ...
                                                <div className="mt-2 h-2 w-full rounded-full bg-gray-300/80 shadow-inner">
                                                    <div
                        ...
                        {totalPages > 1 && (
                            <div className="mt-8 border-t border-white/30 pt-6">
                                <div className="rounded-lg border border-white/40 bg-gradient-to-r from-white/70 to-white/50 p-4 backdrop-blur-sm">
